...
public class CustomExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    private ArrayList<ExpandableGroup> DataList;
    private LayoutInflater myinf = null;

    public CustomExpandableListViewAdapter(Context context, int groupLay, int chlidLay, ArrayList<ExpandableGroup> DataList){
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        TextView childName = (TextView)convertView.findViewById(R.id.txt_child_name);
